...
public class StrategyConfig {
     ...
     * 自定义继承的Mapper类全称，带包名
     */
    private String superMapperClass = MyBatisPlusPackageValV2.BaseMapper;

    /**
     * 自定义继承的Service类全称，带包名
     */
    private String superServiceClass = MyBatisPlusPackageValV2.IService;

    /**
     * 自定义继承的ServiceImpl类全称，带包名
     */
    private String superServiceImplClass = MyBatisPlusPackageValV2.ServiceImpl;
    ...
    public boolean isCapitalModeNaming(String word) {
        return isCapitalMode && GeneratorStringUtils.isCapitalMode(word);
    }
