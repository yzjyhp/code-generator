...
public class GeneratorStringUtils {
    ...
    public static String sqlArgsFill(String content, Object... args) {
        if (GeneratorStringUtils.isEmpty(content)) {
            return null;
        }
        if (args != null) {
    ...
    public static String sqlParam(Object obj) {
        ...
        if (obj instanceof Collection) {
            repStr = GeneratorStringUtils.quotaMarkList((Collection<?>) obj);
        } else {
            repStr = GeneratorStringUtils.quotaMark(obj);
        }
        return repStr;
    }
    ...
    public static String quotaMark(Object obj) {
        ...
        if (obj instanceof CharSequence) {
            // fix #79
            return GeneratorStringEscape.escapeString(srcStr);
        }
        return srcStr;
    }
    ...
    public static String quotaMarkList(Collection<?> coll) {
        ...
        while (iterator.hasNext()) {
            String tempVal = GeneratorStringUtils.quotaMark(iterator.next());
     ...
     * <p>
     * <pre>
     * GeneratorStringUtils.endsWith(null, null)      = true
     * GeneratorStringUtils.endsWith(null, "abcdef")  = false
     * GeneratorStringUtils.endsWith("def", null)     = false
     * GeneratorStringUtils.endsWith("def", "abcdef") = true
     * GeneratorStringUtils.endsWith("def", "ABCDEF") = false
     * </pre>
     *
     ...
     * <p>
     * <pre>
     * GeneratorStringUtils.endsWithIgnoreCase(null, null)      = true
     * GeneratorStringUtils.endsWithIgnoreCase(null, "abcdef")  = false
     * GeneratorStringUtils.endsWithIgnoreCase("def", null)     = false
     * GeneratorStringUtils.endsWithIgnoreCase("def", "abcdef") = true
     * GeneratorStringUtils.endsWithIgnoreCase("def", "ABCDEF") = false
     * </pre>
     *
     * @param str    the String to check, may be null
     * @param suffix the suffix to find, may be null
     ...
     * <p>
     * <pre>
     * GeneratorStringUtils.split(null, *)         = null
     * GeneratorStringUtils.split("", *)           = []
     * GeneratorStringUtils.split("abc def", null) = ["abc", "def"]
     * GeneratorStringUtils.split("abc def", " ")  = ["abc", "def"]
     * GeneratorStringUtils.split("abc  def", " ") = ["abc", "def"]
     * GeneratorStringUtils.split("ab:cd:ef", ":") = ["ab", "cd", "ef"]
     * </pre>
     *
     ...
     * GeneratorStringUtils.firstCharToLower( "UserService" )     = userService
     * GeneratorStringUtils.firstCharToLower( "UserServiceImpl" ) = userServiceImpl
     * </p>
     *
     ...
     * GeneratorStringUtils.removePrefixAfterPrefixToLower( "isUser", 2 )     = user
     * GeneratorStringUtils.removePrefixAfterPrefixToLower( "isUserInfo", 2 ) = userInfo
     * </p>
     *
     * @param rawString 需要处理的字符串
     ...
     * <p>
     * 驼峰转连字符<br>
     * GeneratorStringUtils.camelToHyphen( "managerAdminUserService" ) = manager-admin-user-service
     * </p>
     *
     * @param input
     * @return 以'-'分隔
